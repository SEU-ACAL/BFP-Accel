...
//     // when (comparator.out.valid & (max < comparator.out.bits.max_out)) { 
//     //     max := comparator.out.bits.max_out 
//     // }

//     val comparator_out_bits_max_out = RegInit(0.U(bitwidth.W))
//     comparator_out_bits_max_out  := comparator.out.bits.max_out
//     when (comparator.out.valid & (comparator.out.bits.batch_num < (maxBatch - 1).U)) {
//         max := Mux(max < comparator.out.bits.max_out, comparator.out.bits.max_out, max) 
//     }.otherwise {
//         max := max
//     }

//     val End = RegInit(false.B)
//     End := comparator.out.valid & (comparator.out.bits.batch_num === (maxBatch - 1).U)

//     when (End) {
//         maxu_maxexp_o.valid      := true.B
//         maxu_maxexp_o.bits.max   := max//Mux(comparator.out.bits.max_out > max, comparator.out.bits.max_out, max)
//     }.otherwise {
...
//     val TreeLevel5_out_batch_num = RegInit(0.U((log2Up(maxBatch)).W))
